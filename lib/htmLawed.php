...
/* Conveniece function+constants to simplify calling htmLawed.
 */

define('FOR_SECTION', 0);  // Allows sane HTML tags (editing sections).
define('FOR_COMMENT', 1);  // Removes all tags (comments).

function sanitizeHTML($raw, $for=FOR_SECTION) {
    $config = array(
        'comment'        => 1,
        'cdata'          => 1,
        'deny_attribute' => 'on*',
